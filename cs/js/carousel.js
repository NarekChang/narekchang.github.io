	...
	$carousel.children(':last').after($carousel.children().slice(0,settings.rotateBy).clone(true));
                                        ...
                                        */
                                        ...
                                        if(dir){
                                            ...
                                            $("li:first-child, li:nth-child(n+5)").addClass("disable");
                                        }else{
                                            $("li").removeClass("disable");
                                            $("li:nth-child(6), li:nth-child(2), li:first-child").addClass("disable");                                            
                                        }
										...
										// запускаем анимацию
                                        $carousel.animate(animate_data, {queue: false, duration: 500, complete: function() {
